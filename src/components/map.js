...
export let mapOptions = {
  ...
  // panControl: true,
  // panControlOptions: { positiosn: google.maps.ControlPosition.BOTTOM_LEFT },
  // rotateControl: true,
  // rotateControlOptions: { positiosn: google.maps.ControlPosition.BOTTOM_LEFT },
  // scaleControl: true,
  // scaleControlOptions:  { position: google.maps.ControlPosition.TOP_LEFT },
  // scrollwheel: true,//recomended to use gestureHandling,
  // streetView: ?
}
let circleOptions = {
